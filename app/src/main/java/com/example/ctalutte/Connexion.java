...
public class Connexion extends SQLiteOpenHelper {
    ...
    public void ajouterCamarade(String nomCmarade, Integer scoreCamarade, Integer nbTachesCamarade){
        ...
        String insertCamarade ="INSERT INTO "+TABLE_NAME+" ("+NOM_JOUEUR+", "+SCORE+", "+NB_TACHES+") \n VALUES('"+nomCmarade+"', "+scoreCamarade+", "+nbTachesCamarade+");";
